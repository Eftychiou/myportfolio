  ...
  return (
    <div className={classes.page}>
      ...
      <section id='about_me'>
        ...
        <p>
          In 2019, I embarked on a transformative journey into the dynamic realm of web development. Fueled by a passion
          for crafting immersive digital experiences, my expertise revolves around harnessing the power of React,
          JavaScript, CSS, and Node.js. I thrive on the intricate dance of code, consistently pushing boundaries and
        ...
        <p>
          ...
          into digital tapestries. Join me on this exciting venture, where innovation meets expression, and each project
